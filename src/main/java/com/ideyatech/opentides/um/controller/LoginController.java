...
public class LoginController {
    ...
    ResponseEntity<?> login(
        ...
        JwtAuthenticationToken authenticationToken =
                new JwtAuthenticationToken("", appSecret, username, password);
    ...
    ResponseEntity<?> googleLogin(
        ...
        GoogleIdTokenVerifier verifier = new GoogleIdTokenVerifier.Builder(transport, jsonFactory)
                .setAudience(Arrays.asList(googleWebClientId, googleOAuthClientId))
                .build();
        ...
        if (idToken != null) {
            ...
            if (googleUser == null) {
                ...
                JwtAuthenticationToken authenticationToken =
                        new JwtAuthenticationToken("", appSecret, payload.getEmail(), "mKcMmwN9nVmQG7MABuU7");
...
//    }
    ...
    public @ResponseBody ResponseEntity<?> facebookLogin(@RequestBody UserDTO userDTO,
        ...
        if (user == null) {
            ...
            if (obj.getJSONObject("data") != null && (boolean) obj.getJSONObject("data").get("is_valid")) {
                ...
                JwtAuthenticationToken authenticationToken =
                        new JwtAuthenticationToken("", appSecret, success.getEmailAddress(), "lX7oOrFoU7owJ05qZ2vM");
    ...
    public @ResponseBody ResponseEntity<?> login(
            @RequestParam(required = false, value = "exp") Integer expiration,
            @RequestHeader(value = "OT4-APP-SECRET") String appSecret,
    ...
    public ResponseEntity<?> logout(
            @RequestHeader(value = "OT4-APP-SECRET", required = false) String appSecret,
